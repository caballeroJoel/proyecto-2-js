...
export const hotelsPopulars = [
  {
    ...
    imatgeUrl: "lakeside-motel",
    propietatsCount: 2246,
  },
  {
    id: "rocce-graham-resort",
    nom: "Rocce Graham resort",
    imatgeUrl: "rocce-graham",
    propietatsCount: 1278,
  },
  {
    id: "fireside-dinners",
    nom: "Fireside Dinners",
    imatgeUrl: "fireside-dinners",
    propietatsCount: 480,
  },
  {
    id: "oculous-inn-stay",
    nom: "Oculous Inn Stay",
    imatgeUrl: "oculous-inn",
    propietatsCount: 320,
  },
];
...
export const searchResultsData = {
  ...
  results: [
    {
      hotelId: "lakeside-motel-warefront-1",
    ...
    {
      hotelId: "lakeside-motel-warefront-2",
      name: "Lakeside Motel Warefront",
      rating: 4.5,
      reviewsCount: 1200,
      description:
...
export const productDetailData = {
  ...
  promoCard: {
    title: "20% off<br>Use Promotional<br>Coupon Code:<br><span>Orlando</span>",
  },
  rooms: [
    {
...
export const myTripsData = {
  ...
  suggestedDestinations: [
    ...
    },
    {
      id: "new-zealand",
      nom: "New Zealand",
      imatgeUrl: "nueva-zelanda.jpg",
      propietatsCount: 480,
    },
    {
      id: "greece",
      nom: "Greece",
      imatgeUrl: "grecia.jpg",
      propietatsCount: 320,
    },
  ],
};